...
const businessEngagementsDataDefault = { engagements: [], error: false };
...
export default function Start() {
  ...
  const [businessEngagements, setBusinessEngagements] =
    useState<BusinessEngagementData>(businessEngagementsDataDefault);
